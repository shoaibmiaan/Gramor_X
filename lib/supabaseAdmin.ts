...
// 🔍 DEVELOPMENT DEBUG: log the first few characters to verify the key is loaded
if (process.env.NODE_ENV === 'development') {
  console.log('[supabaseAdmin] URL loaded:', !!url);
  console.log('[supabaseAdmin] Service key starts with:', serviceRoleKey?.substring(0, 8));
}
