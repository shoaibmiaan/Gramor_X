      ...
      <Container>
        <div className="mb-6 flex items-center justify-between gap-4">
          ...
          <div className="flex flex-col items-end gap-2">
            ...
            {rec.isRecording && <Badge variant="warning">Recording… {rec.sec}s</Badge>}
          </div>
        </div>
          ...
          <Card className="p-0 lg:col-span-2 overflow-hidden flex flex-col">
            ...
            <div className="p-4 border-t border-black/5 dark:border-white/10">
              <div className="flex items-center gap-2">
                ...
                <Button variant={rec.isRecording ? destructive : 'primary'} onClick={handleRecordToggle} disabled={busy}>
