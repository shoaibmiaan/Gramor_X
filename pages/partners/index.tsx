      ...
      <main className="min-h-screen bg-background text-foreground">
        <div className="mx-auto max-w-5xl px-4 py-8">
          <header className="mb-6 flex items-center justify-between">
            <div>
              <h1 className="text-h1 font-semibold">Partner Dashboard</h1>
              <p className="text-small text-muted-foreground">
                Track redemptions from your referral codes and see your performance.
              </p>
            </div>
            <div className="flex gap-2">
              <Link href="/account/referrals" className="rounded-lg bg-primary px-3 py-2 text-small text-primary-foreground hover:opacity-90">
                Generate / Share Code
              </Link>
              <Link href="/admin/partners" className="rounded-lg border border-border px-3 py-2 text-small hover:bg-muted">
                Admin view
              </Link>
            </div>
          </header>
          ...
          <section className="mt-8 rounded-xl border border-border p-4">
            <h2 className="text-h4 font-medium">Tips to grow</h2>
