...
import { createServerClient } from '@supabase/ssr'; // ✅ server‑side client
import { Container } from '@/components/design-system/Container';
import { Card } from '@/components/design-system/Card';
import { Button } from '@/components/design-system/Button';
import { Badge } from '@/components/design-system/Badge';
import { supabaseBrowser } from '@/lib/supabaseBrowser'; // ✅ client‑side singleton (should use createBrowserClient)
  ...
  const supabase = createServerClient(
    ...
    env.NEXT_PUBLIC_SUPABASE_ANON_KEY,
    {
      cookies: {
        ...
        set() {
          // We're not setting cookies in this server‑side call, so ignore
        },
        remove() {
          // We're not removing cookies in this server‑side call, so ignore
        },
      },
    }
  );
