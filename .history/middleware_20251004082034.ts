...
export async function middleware(req: NextRequest) {
  ...
  // Always create a mutable response so cookie refreshes can be written back
  const res = NextResponse.next();

  // ✅ Use SSR client with explicit cookie adapter (read, set, remove)
  ...
  // Get/refresh the session so updated cookies are attached to `res`
  ...
  // --- Premium PIN gate (precedence over generic auth) ---
