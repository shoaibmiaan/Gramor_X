          ...
          <Card as="section" padding="lg" insetBorder>
            <form onSubmit={onSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                <label htmlFor="name" className="text-small text-muted-foreground">Name on card</label>
                <input
                  id="name"
                  className="input"
              ...
              {/* Card element */}
              <div className="space-y-2">
                <label className="text-small text-muted-foreground">Card</label>
                <div className="rounded-ds-xl border border-border/60 bg-background px-3 py-3">
                  {/* We avoid inline styles; CardElement renders its own iframe styling */}
